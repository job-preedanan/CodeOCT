...
mkdir(pathname,'TestingResult2');
mkdir(pathname,'TestingResult2\applyBilaterfilt');
...
%     figure(1),subplot(2,2,4),imshow(ILM_layer);
    ...
    filename0 = [pathname 'TestingResult2\applyBilaterfilt\' idx '_bf.tif'];
    filename1 = [pathname 'TestingResult2\' idx '_multithresh.tif'];
    filename2 = [pathname 'TestingResult2\' idx '_RPE-layer.tif'];
    filename3 = [pathname 'TestingResult2\' idx '_ILM-layer.tif'];
    filename5 = [pathname 'TestingResult2\' idx '_LayerBoundary.tif'];
